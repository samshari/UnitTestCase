...
{
    public class MattingPreConstructionRequiredRepository : IMattingPreConstructionRequiredRepository
    {
        private readonly string _connectionString;
        private readonly string _storedProcedure = "dbo.spCOMMONREQActions";

        public MattingPreConstructionRequiredRepository(IAppSettings appSettings)
        {
