...
{
    public class STACKINGPreConstructionRequiredRepository : ISTACKINGPreConstructionRequiredRepository
    {
        private readonly string _connectionString;
        private readonly string _storedProcedure = "dbo.spCOMMONREQActions";

        public STACKINGPreConstructionRequiredRepository(IAppSettings appSettings)
        {
